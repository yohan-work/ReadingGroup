...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo123123.png" alt="<?php echo $config['cf_title']; ?>"></a>
        </div>
        ...
        <div class="hd_sch_wr">
            <fieldset id="hd_sch">
                ...
                <input type="text" name="stx" id="sch_stx" maxlength="20" placeholder="검색어를123123 입력해주세요">
